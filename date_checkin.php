<?php 
 ...
 <div class='last_month' onclick=last_month_checkin(".$month_select.",".$year_select.")><<</div>
 <div class='current_month'>$title_select $year_select</div>
 <div class='next_month' onclick=next_month_checkin(".$month_select.",".$year_select.")>>></div></th></tr>";
...
//sets the first day of the month to 1 
 ...
 { 
 echo "<td><a onclick=change_checkin_selector_value(".$day_num.",".$month_select.",".$year_select.")>$day_num</a></td>"; 
 $day_num++; 
 $day_count++;
