<?php 
 ...
 <div class='last_month' onclick=last_month(".$month_select.",".$year_select.")><<</div>
 <div class='current_month'>$title_select $year_select</div>
 <div class='next_month' onclick=next_month(".$month_select.",".$year_select.")>>></div></th></tr>";
...
//sets the first day of the month to 1 
 ...
 { 
 echo "<td onclick=change_checkin_selector_value(".$day_num.",".$month_select.",".$year_select.")>$day_num</td>"; 
 $day_num++; 
 $day_count++;
