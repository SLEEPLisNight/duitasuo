 ...
 */
 ...
 echo "<a><li class='post_action' id='edit_msg_".$msgid."' onclick='edit_msg(".$msgid.")' onmouseover=this.className='post_action_onmouseover' onmouseout=this.className='post_action'>修改</li></a>
       <a><li class='post_action' id='cancel_msg_".$msgid."' onclick='cancel_msg_my_msgs(".$msgid.")' onmouseover=this.className='post_action_onmouseover' onmouseout=this.className='post_action'>删除通告</li></a>";
...
if ($mymsgs == 0){
echo "<div class='post'>
      <h4 onselectstart='return false'>您没有发布任何信息。</h4>
      </div>";
}
